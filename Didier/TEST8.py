class Hotel:
    ...
    def SetNumeroEstrellas(self, estrellas):
...
negocio = Negocio()
negocio.SetNumeroEstrellas(4)
negocio.SetNumeroHabitaciones(255)
negocio.SetTenedores(3)
negocio.SetHoraApertura(20)
negocio.SetNombre("La cuisine du Didier")
negocio.SetDireccion("Calle del Programador 53")
negocio.SetTelefono("663971325")
